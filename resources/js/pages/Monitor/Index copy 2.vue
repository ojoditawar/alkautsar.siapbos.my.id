...
const streamingCheckIntervalRef: ReturnType<typeof setInterval> | null = null;
    ...
    if (nextTime) {
        ...
        if (
            ...
            if (nextTime.name === 'DZUHUR' && new Date().getDay() === 5) {
                ...
                sholatEndTime.value = new Date(now.getTime() + jumatDur * 60 * 1000);
                sholatCountdown.value = '00:' + String(jumatDur).padStart(2, '0') + ':00';
                currentSlide.value = 'sholat';
                stopRotation();
            } else {
...
onMounted(() => {
    ...
    const si = setInterval(checkStreamingSchedule, 1000);
    (streamingCheckIntervalRef as any) = si;

    startRotation();
});

onUnmounted(() => {
    if (streamingCheckIntervalRef) clearInterval(streamingCheckIntervalRef);
});
        ...
        <div class="content-wrapper">
            ...
            >
                ...
                >
                    ...
                    <p
                        class="mt-10 text-center text-2xl font-semibold tracking-wider text-emerald-300 sm:text-3xl"
                    >
            ...
            >
                ...
                >
                    ...
                    <p
                        class="mb-6 text-center text-lg font-medium leading-relaxed text-amber-200 sm:text-xl"
                    >
                        Alat Komunikasi Termasuk Handphone mohon di Non Aktifkan
                        (Mode Silent) untuk menjaga Kekhusyukan dan
                        Kesempurnaan Ibadah Sholat Jumat
                    </p>
                    <p
                    ...
                    <p
                        class="mt-6 text-center text-lg font-semibold text-emerald-300 sm:text-xl"
                    >
