...
const imagePreview = ref<string | null>(
    props.jamaah.foto ? props.jamaah.foto : null
);
const imageFile = ref<File | null>(null);

const form = useForm({
    _method: 'put',
    nama: props.jamaah.nama,
    rt: props.jamaah.rt ?? '',
    rw: props.jamaah.rw ?? '',
    blok: props.jamaah.blok ?? '',
    no_rumah: props.jamaah.no_rumah ?? '',
    alamat: props.jamaah.alamat ?? '',
    telpon: props.jamaah.telpon ?? '',
    art: props.jamaah.art,
...
function submit() {
    form.post(`/jamaahs/${props.jamaah.id}`);
}
</script>

<template>
    <Head title="Edit Data Jamaah" />
        ...
        <Card>
            <CardHeader>
                <div class="flex items-center justify-between">
                    <div>
                        <CardTitle>Edit Data Jamaah</CardTitle>
                        <CardDescription>
                            Ubah data jamaah/warga di lingkungan Griya Anggraini.
                        </CardDescription>
                    </div>
