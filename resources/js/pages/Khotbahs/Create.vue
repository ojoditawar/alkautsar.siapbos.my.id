...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Tambah', href: '/khotib-jumat/create' },
        ],
    },
});
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold">Tambah Khotbah</h1>
                <p class="text-sm text-muted-foreground">
                    Tambah data khotib jumat baru
                </p>
            </div>
        </div>
        ...
        <Card class="max-w-2xl">
            <CardHeader>
                <CardTitle>Form Tambah Khotbah</CardTitle>
                <CardDescription>
                    Isi data khotib jumat di bawah ini.
                </CardDescription>
            </CardHeader>
            <CardContent>
