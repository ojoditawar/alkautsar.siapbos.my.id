...
function submit() {
    form.post('/running-texts');
}
</script>

<template>
    <Head title="Tambah Running Text" />
        ...
        <Card>
            <CardHeader>
                <div class="flex items-center justify-between">
                    <div>
                        <CardTitle>Tambah Running Text</CardTitle>
                        <CardDescription>
                            Pesan akan muncul di pita atas Dashboard ketika status Aktif.
                        </CardDescription>
                    </div>
                ...
                <form class="space-y-6" @submit.prevent="submit">
                    <div class="grid gap-2">
                        ...
                        <textarea
                            ...
                            placeholder="Contoh: Jadwal Kajian Rutin Malam Jumat..."
                        />
