...
const form = useForm({
    ...
    jabatan: 'Imam Masjid Al Kautsar',
    tipe: 'utama',
    sholat: 'SUBUH',
});
...
function submit() {
    form.post('/imam-masjids');
}
</script>

<template>
    <Head title="Tambah Imam Masjid" />
        ...
        <Card>
            <CardHeader>
                <div class="flex items-center justify-between">
                    <div>
                        <CardTitle>Tambah Imam & Cadangan (Badal)</CardTitle>
                        <CardDescription>
                            Tambahkan Imam Utama atau Cadangan baru untuk jadwal sholat tertentu.
                        </CardDescription>
                    </div>
