...
<template>
    ...
    <Head title="Tambah Masjid" />

    <div class="flex h-full flex-1 flex-col gap-6 p-4">
        <Card class="mx-auto w-full max-w-2xl">
            <CardHeader>
                <CardTitle>Tambah Masjid Baru</CardTitle>
                <CardDescription>Isi form berikut untuk menambahkan masjid baru ke sistem.</CardDescription>
            </CardHeader>
            <CardContent>
