...
const permissionGroups = computed<PermissionGroup[]>(() => {
    ...
    // Map entity names to display labels
    ...
    const actionLabels: Record<string, string> = {
        manage: 'Lihat Halaman',
        create: 'Tambah Data',
        edit: 'Ubah Data',
        delete: 'Hapus Data',
    };

    // Sort permissions: manage/* first, then az by entity
    ...
    // Sort groups: manage entities first, then alphabetically
